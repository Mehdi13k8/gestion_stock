...
class LigneBonCommandeSortie_pour_import_BonCommandeSortie(models.Model):
    ...
    idLigneBonCommandeSortie = models.CharField(max_length=42, default=0)
    quantiteProduitCommande = models.CharField(max_length=42, default=0)
    quantiteColisCommande  = models.CharField(max_length=42, default=0)
    quantiteProduitALivrer = models.CharField(max_length=42, default=0)
    quantiteProduitLivre = models.CharField(max_length=42, default=0)
    quantiteColisLivre = models.CharField(max_length=42, default=0)
    quantiteProduitPotentielle = models.CharField(max_length=42, default=0)
    quantiteColisPotentielle = models.CharField(max_length=42, default=0)
    differenceCommandeLivre = models.CharField(max_length=42, default=0)
    differenceCommandePotentiel = models.CharField(max_length=42, default=0)
    priorite = models.CharField(max_length=42, default=0)
    termine = models.CharField(max_length=42, default=0)
    priorite = models.CharField(max_length=42, default=0)
...
'''class Article_pour_BonCommandeSortie(models.Model):
    ...
    codeFournisseur = models.CharField(max_length=42, default=0)
    codeClient = models.CharField(max_length=42, default=0)
    designationFournisseur = models.CharField(max_length=42, default=0)
    designationClient = models.CharField(max_length=42, default=0)
    dureeStockage = models.CharField(max_length=42, default=0)
    delaiPeremption = models.CharField(max_length=42, default=0)
    stock = models.CharField(max_length=42, default=0)
    poidsColisStandard = models.CharField(max_length=42, default=0)
    quantiteColisStandard = models.CharField(max_length=42, default=0)
    quantiteColisStockComplet = models.CharField(max_length=42, default=0)
    quantiteProduitStockComplet = models.CharField(max_length=42, default=0)
    quantiteColisStockIncomplet = models.CharField(max_length=42, default=0)
    quantiteProduitStockIncomplet = models.CharField(max_length=42, default=0)
    quantiteUniteManutentionSortie = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)
    identifiantSource = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class Client_pour_import_BonCommandeSortie(models.Model):
    ...
    adresse = models.CharField(max_length=42, default=0)
    ...
    siret = models.CharField(max_length=42, default=0)
    tva = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)
    identifiantSource = models.CharField(max_length=42, default=0)
    nomCompte = models.CharField(max_length=42, default=0)
    def __str__(self):
...
class BonCommandeEntree(models.Model):
    idBonCommandeEntree = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    numeroCommande = models.CharField(max_length=42, default=0)
    dateCommande = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)
...
class LigneBonCommandeEntree_pour_BonCommandeEntree(models.Model):
    idLigneBonCommandeEntree = models.CharField(max_length=42, default=0)
    identifiantSource = models.CharField(max_length=42, default=0)
    dateLivraison = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)
    quantiteColis = models.CharField(max_length=42, default=0)
    quantiteProduit = models.CharField(max_length=42, default=0)
    quantiteRecue = models.CharField(max_length=42, default=0)
    fk_Article = models.ForeignKey('Article', on_delete=models.CASCADE, default=0)
...
'''class Article_pour_BonCommandeEntree(models.Model):
    idArticle = models.CharField(max_length=42, default=0)
    fk_BonCommandeEntree = models.ForeignKey('BonCommandeEntree', on_delete=models.CASCADE, default=0)
...
'''class BonCommandeEntree_BonLivraisonEntree_pour_BonCommandeEntree(models.Model):
    idBonCommandeEntree_BonLivraisonEntree = models.CharField(max_length=42, default=0)
    fk_BonCommandeEntree = models.ForeignKey('BonCommandeEntree', on_delete=models.CASCADE, default=0)
...
'''class BonLivraisonEntree_pour_BonCommandeEntree(models.Model):
    idBonLivraisonEntree = models.CharField(max_length=42, default=0)
    #fk_BonCommandeEntree = models.ForeignKey('BonCommandeEntree', on_delete=models.CASCADE, default=0)
    ...
    fk_Fournisseur = models.ForeignKey('Fournisseur', on_delete=models.CASCADE, default=0, blank=True, null=True)
    fk_Destinataire_litige = models.ForeignKey('Destinataire', on_delete=models.CASCADE, default=0)
    #fk_ZoneDepot_litige = models.ForeignKey('Destinataire_pour_UniteManutentionEntree_litige', on_delete=models.CASCADE, default=0)
    fichier = models.CharField(max_length=42, default=0)
    photo = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.idBonLivraisonEntree'''

'''class UniteManutentionEntree_pour_BonCommandeEntree(models.Model):
    id_BonCommandeEntree = models.CharField(max_length=42, default=0)
    id_dateReception = models.CharField(max_length=42, default=0)
    #fk_BonLivraisonEntree = models.ForeignKey('BonLivraisonEntree_pour_BonCommandeEntree', on_delete=models.CASCADE, default=0)
    def __str__(self):
        return self.id_BonCommandeEntree'''

'''class Colis_pour_BonCommandeEntree(models.Model):
    idColis = models.CharField(max_length=42, default=0)
...
'''class LigneBonLivraisonEntree_pour_BonCommandeEntree(models.Model):
    idLigneBonLivraisonEntree = models.CharField(max_length=42, default=0)
    fk_BonLivraisonEntree = models.ForeignKey('BonLivraisonEntree', on_delete=models.CASCADE, default=0)
    fk_Article = models.ForeignKey('Article', on_delete=models.CASCADE, default=0)
    controle = models.CharField(max_length=42, default=0)
    quantiteColis = models.CharField(max_length=42, default=0)
    quantiteColisAlivrer = models.CharField(max_length=42, default=0)
    quantiteColisLitige = models.CharField(max_length=42, default=0)
    quantiteColisRecu = models.CharField(max_length=42, default=0)
    quantiteCommande = models.CharField(max_length=42, default=0)
    quantiteCommandeRecue = models.CharField(max_length=42, default=0)
    quantiteDifference = models.CharField(max_length=42, default=0)
    quantiteDifferenceAutre = models.CharField(max_length=42, default=0)
    quantiteDifferenceRestante = models.CharField(max_length=42, default=0)
    quantiteProduit = models.CharField(max_length=42, default=0)
    quantiteProduitALivrer = models.CharField(max_length=42, default=0)
    quantiteProduitLitige = models.CharField(max_length=42, default=0)
    quantiteProduitRecu = models.CharField(max_length=42, default=0)
    quantiteRecue = models.CharField(max_length=42, default=0)
    termine = models.CharField(max_length=42, default=0)'''
...
class LettreVoitureEntree(models.Model):
    idLettreVoitureEntree = models.CharField(max_length=42, default=0)
    datereception = models.CharField(max_length=42, default=0)
    numerorecepisse = models.CharField(max_length=42, default=0)
    quantitepalette = models.CharField(max_length=42, default=0)
    quantitecolis = models.CharField(max_length=42, default=0)
    reclaquantitepalette = models.CharField(max_length=42, default=0)
    reclaquantitecolis = models.CharField(max_length=42, default=0)
    reclacomm = models.CharField(max_length=42, default=0)
...
'''class Client_pour_LettreVoitureEntree(models.Model):
    idClient = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.idClient'''
...
class LettreVoitureSortie(models.Model):
    idLettreVoitureSortie = models.CharField(max_length=42, default=0)
    datereception = models.CharField(max_length=42, default=0)
    numerorecepisse = models.CharField(max_length=42, default=0)
    quantitepalette = models.CharField(max_length=42, default=0)
    quantitecolis = models.CharField(max_length=42, default=0)
...
'''class Colis_pour_Article(models.Model):
    ...
    emplacementConfirme = models.CharField(max_length=42, default=0)
    numeroLot = models.CharField(max_length=42, default=0)
    datePeremption = models.CharField(max_length=42, default=0)
    quantiteProduit = models.CharField(max_length=42, default=0)
    numerotation = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.idColis'''
...
class Article_historique_pour_Article(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idArticle_historique = models.CharField(max_length=42, default=0)
    nomFournisseur = models.CharField(max_length=42, default=0)
    codeFournisseur = models.CharField(max_length=42, default=0)
    designationFournisseur = models.CharField(max_length=42, default=0)
    codeClient = models.CharField(max_length=42, default=0)
    designationClient = models.CharField(max_length=42, default=0)
    poids = models.CharField(max_length=42, default=0)
    delaiPeremption = models.CharField(max_length=42, default=0)
    dureeStockage = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class Fournisseur_pour_Article_historique(models.Model):
    ...
    idFournisseur = models.CharField(max_length=42, default=0)
    nom = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)
    identifiantSource = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class Article_Destinataire_pour_Article(models.Model):
    ...
    idArticle_Destinataire = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
    ...
    m_horodatage = models.CharField(max_length=42, default=0)
    delaiPeremption = models.CharField(max_length=42, default=0)
    #Rubrique11 = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class Client_pour_Article_typeDestinataire(models.Model):
    ...
    fk_TypeArticle = models.ForeignKey('typeArticle_pour_Article', on_delete=models.CASCADE, default=0)
    nom = models.CharField(max_length=42, default=0)
    adress = models.CharField(max_length=42, default=0)
    commentaire = models.CharField(max_length=42, default=0)
    telephone = models.CharField(max_length=42, default=0)
    email = models.CharField(max_length=42, default=0)
    siret = models.CharField(max_length=42, default=0)
...
class typeArticle_pour_Article(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idTypeArticle = models.CharField(max_length=42, default=0)
    nom = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.nom
...
'''class BonCommandeSortie_pour_Destinataire(models.Model):
    idBonCommandeSortie = models.CharField(max_length=42, default=0)
...
'''class UniteManutentionSortie_pour_Destinataire(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idUniteManutentionSortie = models.CharField(max_length=42, default=0)
    ...
    numero = models.CharField(max_length=42, default=0)
    dateOuverture = models.CharField(max_length=42, default=0)
    dateFermeture = models.CharField(max_length=42, default=0)
    dateExpedition = models.CharField(max_length=42, default=0)
    poidsBrut = models.CharField(max_length=42, default=0)
    poidsTare = models.CharField(max_length=42, default=0)
    poidsNet = models.CharField(max_length=42, default=0)
    poidsDifference = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.numero'''
...
class Pays_pour_Destinataire(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idPays = models.CharField(max_length=42, default=0)
    nom = models.CharField(max_length=42, default=0)
    codeISO_2 = models.CharField(max_length=42, default=0)
    codeISO_3 = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.nom
    #endof destinataire
...
class OrdreTransport_pour_Client(models.Model):
    idOrdreTransport = models.CharField(max_length=42, default=0)
    fk_Client = models.ForeignKey('Client', on_delete=models.CASCADE, default=1)
    fk_LettreVoitureEntree = models.ForeignKey('LettreVoitureEntree', on_delete=models.CASCADE, default=1)
    fk_Transporteur = models.ForeignKey('Transporteur', on_delete=models.CASCADE, default=1)
    c_nom = models.CharField(max_length=42, default=0)
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    dateCreation = models.CharField(max_length=42, default=0)
    '''

class Contact_pour_Client(models.Model):
    idContact = models.CharField(max_length=42, default=0)
    fk_Client = models.ForeignKey('Client', on_delete=models.CASCADE, default=1)
    ...
    m_horodatage = models.CharField(max_length=42, default=0)
    nom = models.CharField(max_length=42, default=0)
    prenom = models.CharField(max_length=42, default=0)
    telephone = models.CharField(max_length=42, default=0)
    email = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.nom
...
class RoleContact_pour_Client(models.Model):
    idRoleContact = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
...
'''class TypeZoneDepot_pour_Client(models.Model):
    idTypeZoneDepot = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
...
class TypeFournisseur_pour_Client(models.Model):
    idTypeFournisseur = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
...
class ZoneDepot_pour_TypeZoneDepot(models.Model):
    ...
    idZoneDepot = models.CharField(max_length=42, default=0)
    c_nom = models.CharField(max_length=42, default=0)
    c_nomCompte = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
    m_nom = models.CharField(max_length=42, default=0)
...
class TypeBonCommandeSortie_pour_BonCommandeSortie(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idTypeBonCommandeSortie = models.CharField(max_length=42, default=0)
    nom = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.nom
...
class UniteManutentionEntree(models.Model):
    idUniteManutentionEntree = models.CharField(max_length=42, default=0)
...
'''class EtiquetteColis_pour_UniteManutentionEntree_historique(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idEtiquetteColis = models.CharField(max_length=42, default=0)
    expediteur = models.CharField(max_length=42, default=0)
    codeArticleFournisseur = models.CharField(max_length=42, default=0)
    nomCompte = models.CharField(max_length=42, default=0)
    quantiteProduit = models.CharField(max_length=42, default=0)
    numeroLot = models.CharField(max_length=42, default=0)
    datePeremption = models.CharField(max_length=42, default=0)
    designationArticleFournisseur = models.CharField(max_length=42, default=0)
    codeUM = models.CharField(max_length=42, default=0)
    Fournisseur = models.CharField(max_length=42, default=0)
    datamatrix_humaine = models.CharField(max_length=42, default=0)
    retour = models.CharField(max_length=42, default=0)
    collee = models.CharField(max_length=42, default=0)
    afficherExpediteur = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.nom'''
...
'''class Colis_ZoneDepot_pour_UniteManutentionEntree(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idColis_ZoneDepot = models.CharField(max_length=42, default=0)
    fk_ZoneDepot = models.ForeignKey('ZoneDepot_pour_UniteManutentionEntree_colis', on_delete=models.CASCADE, default=1)
    dateEntree = models.CharField(max_length=42, default=0)
    dateSortie = models.CharField(max_length=42, default=0)'''
    #def __str__(self):
    #return self.nom
...
'''class Colis_UniteManutentionSortie_pour_UniteManutentionEntree(models.Model):
    fk_Colis = models.ForeignKey('Colis_pour_UniteManutentionEntree', on_delete=models.CASCADE, default=1)
    fk_UniteManutentionSortie = models.ForeignKey('UniteManutentionSortie_pour_UniteManutentionEntree', on_delete=models.CASCADE, default=1)
    idColis_UniteManutentionSortie = models.CharField(max_length=42, default=0)'''
...
'''class Litige_pour_UniteManutentionEntree(models.Model):
    idLitige = models.CharField(max_length=42, default=0)'''

'''class LitigeDecision_pour_UniteManutentionEntree(models.Model):
    idLitigeDecision = models.CharField(max_length=42, default=0)'''
...
'''class LotRetire_pour_UniteManutentionEntree_pour_UniteManutentionEntree_historique(models.Model):
    ...
    c_nom = models.CharField(max_length=42, default=0)
    idLotRetire = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class EtiquetteUniteManutentionEntree_pour_UniteManutentionEntree_historique(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    idEtiquetteUniteManutentionEntree = models.CharField(max_length=42, default=0)
    def __str__(self):
...
'''class EtiquetteUniteManutentionEntree_pour_UniteManutentionEntree(models.Model):
    ...
    m_nomCompte = models.CharField(max_length=42, default=0)
    m_horodatage = models.CharField(max_length=42, default=0)
    client = models.CharField(max_length=42, default=0)
    numeroUM = models.CharField(max_length=42, default=0)
    zone = models.CharField(max_length=42, default=0)
    fournisseur = models.CharField(max_length=42, default=0)
    quantiteColis = models.CharField(max_length=42, default=0)
    dateReception = models.CharField(max_length=42, default=0)
    nomCompte = models.CharField(max_length=42, default=0)
...
class Colis(models.Model):
    ...
    datePeremption = models.CharField(max_length=42, default=0)
    quantiteProduit = models.CharField(max_length=42, default=0)
    colle = models.CharField(max_length=42, default=0)
    numerotation = models.CharField(max_length=42, default=0)
    def __str__(self):
        return self.idColis
...
'''class LotRetire_pour_Colis(models.Model):
    ...
    dateRetrait = models.CharField(max_length=42, default=0)
    identifiantSource = models.CharField(max_length=42, default=0)
    idLotRetire = models.CharField(max_length=42, default=0)
    numeroLot = models.CharField(max_length=42, default=0)
    source = models.CharField(max_length=42, default=0)'''
...
class BonLivraisonSortie(models.Model):
    ...
    dateImpression = models.CharField(max_length=42, default=0)
    numeroBonLivraison = models.CharField(max_length=42, default=0)
    prixExpedition = models.CharField(max_length=42, default=0)
    codeTracking = models.CharField(max_length=42, default=0)
    c_horodatage = models.CharField(max_length=42, default=0)
...
class LigneBonLivraisonSortie_pour_BonLivraisonSortie(models.Model):
    idLigneBonLivraisonSortie = models.CharField(max_length=42, default=0)
    fk_BonLivraisonSortie = models.ForeignKey('BonLivraisonSortie', on_delete=models.CASCADE, default=1)
    fk_Article = models.ForeignKey('Article', on_delete=models.CASCADE, default=1)
    fk_Transporteur = models.ForeignKey('Transporteur', on_delete=models.CASCADE, default=1)
    quantiteColis = models.CharField(max_length=42, default=0)
    stat_quantiteColis = models.CharField(max_length=42, default=0)
...
class UniteManutentionSortie(models.Model):
    ...
    #fk_Etiquette = models.ForeignKey('EtiquetteUniteManutentionEntree_pour_UniteManutentionEntree', on_delete=models.CASCADE, default=1)
    #fk_TypeUniteManutention_pour_UniteManutentionSortie = models.ForeignKey('TypeUniteManutention_pour_UniteManutentionSortie', on_delete=models.CASCADE, default=0, blank=True, null=True)
